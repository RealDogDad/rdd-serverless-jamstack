...
const getInventory = async () => {
  let results = await axios.get('https://faas-nyc1-2ef2e6cc.doserverless.co/api/v1/web/fn-a178602b-db5e-449c-9212-5be181ff7c01/cloud/getCoffee');
...
const subscribeHandler = async function() {
  ...
  let emailUrl = "https://faas-nyc1-2ef2e6cc.doserverless.co/api/v1/web/fn-a178602b-db5e-449c-9212-5be181ff7c01/cloud/postEmail" + "?email=" + email;
